...
import { TosContent } from "@/components/public-pages/public-page-content";
    ...
    <main className="min-h-screen w-full bg-[#1B2A28]">
      ...
      <section className="max-w-4xl mx-auto px-6 py-10 text-theme-text-light">
        <h1 className="text-2xl md:text-3xl font-bold mb-2">
          {t.publicPages.tos.title}
        </h1>
        <p className="text-sm text-zinc-400 mb-8">
          {t.publicPages.tos.effectiveDate}
        </p>

        <TosContent content={t.publicPages.tos.content} />
      </section>
    </main>
  );
}
